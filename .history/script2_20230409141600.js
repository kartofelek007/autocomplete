    ...
    bindEvents() {
        ...
        this.input.addEventListener("keydown", e => {
            if (this.list) {
                ...
                const c = this.list.children[this.selectIndex];
                console.log(c.offsetTop , this.list.scrollTop);
                if (c.offsetTop < this.list.scrollTop || c.offsetTop + c.offsetHeight > this.list.scrollTop + this.list.offsetHeight) {
                    c.scrollIntoView();
                }
